...
2. Veritabanı bilgilerinizi `config/database.local.php` dosyasını oluşturarak (veya `config/database.ini` kullanarak) tanımlayın; örnekler için `.example` dosyalarına bakın. Çekirdek `config/database.php` dosyasını doğrudan düzenlemeniz gerekmez.
